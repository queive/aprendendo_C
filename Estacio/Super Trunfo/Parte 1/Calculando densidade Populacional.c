...
int populacaoA = 12325000, TuristicoA = 50;
...
int populacaoB = 6748000, TuristicoB = 30;
...
printf("1° Carta PIB per Capita: %.2f reais", PIBperA);
printf("\n");
printf("Carta 2:\n");
...
printf("1° Carta Densidade Populacional: %.2f hab/km²\n", DensidadePOPB);
printf("1° Carta PIB per Capita: %.2f reais", PIBperB);
